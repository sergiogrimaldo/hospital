...
<html lang="en">
	<head>
		<title>Doctr | Editar detalles Doctor</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doctor | Editar detalles Doctor</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Doctor</span>
									...
									<li class="active">
										<span>Editar detalles Doctor</span>
									</li>
								</ol>
							</div>
						</section>
...
<p><b>>Fecha de perfil: </b><?php echo htmlentities($data['creationDate']);?></p>
